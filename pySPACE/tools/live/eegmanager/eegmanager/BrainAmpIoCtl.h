...
#ifndef __BRAINAMPIOCTL__
#define __BRAINAMPIOCTL__
...
/* the following values are taken from some kind of cifs mount program.. */
...
//; Brain Amp Setup. 
{
	...
	USHORT 	nHoldValue;			// Hold value for digital input
